...
cp -r /home/stefan/RiderProjects/BKB/shell/bin/Release/net8.0/win-x64/publish/* /home/stefan/Windows/SchILD-NRW/publish/
/home/stefan/.dotnet/dotnet publish -c Release -r linux-x64 --self-contained true 
cp -r /home/stefan/RiderProjects/BKB/shell/bin/Release/net8.0/linux-x64/publish/* /home/stefan/bin/bkb/
chmod +x /home/stefan/bin/bkb/BKB
