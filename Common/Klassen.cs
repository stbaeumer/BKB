...
public class Klassen : List<Klasse>
{
    ...
    public Klassen(int periode, Lehrers lehrers, Raums raums)
    {
...
FROM Class LEFT JOIN Teacher ON Class.TEACHER_ID = Teacher.TEACHER_ID WHERE (((Class.SCHOOLYEAR_ID)=" +
            ...
            finally
            {
                ...
                Global.ZeileSchreiben("Klassen", this.Count().ToString(),
    ...
    internal void Klassenpflegschaft(string dateiname, Students schuelers, Lehrers lehrers, Raums raums,
