...
public class Gruppen : List<Gruppe>
{
    ...
    {        
        ...
        Global.DisplayCenteredBox(
            new List<string>()
            {
                "Die Bildungsgänge werden aus den Anrechnungen ermittelt. 2 Dinge sind wichtig",
                "1. Das Wort 'Bildungsgangleitung' muss im Text in Untis enthalten sein",
                "2. einen Link 'bildungsgaenge: ...' in der Beschr."
            }, 90);
        ...
        Lehrers lehrers)
    {
        ...
        Global.DisplayCenteredBox(
            new List<string>()
            {
                "Die Schulformen werden aus den Anrechnungen ermittelt. Der Name der Schulformen wird aus der Untis-Beschr. ausgelesen"
            }, 90);
